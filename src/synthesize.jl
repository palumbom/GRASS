...
function line_profile_cpu!(mid::T, dA::T, ld::T, ext::T, lambdas::AA{T,1}, prof::AA{T,1}, wsp::SynthWorkspaceEclipse{T}, ext_toggle) where T<:AF
...
function line_profile_cpu!(mid::T, dA::T, ld::T, ext::T, lambdas::AA{T,1}, prof::AA{T,1},
                           ...
                           allwavs::AA{T,1}, allints::AA{T,1}, ext_toggle) where T<:AF
