...
function line_profile!(mid::T, lambdas::AA{T,1}, prof::AA{T,1}, wsp::SynthWorkspace{T}) where T<:AF
    # synthesize the line profile given bisector and width input data
    line_profile!(mid, lambdas, prof, wsp.wavt, wsp.dept, wsp.widt,
                  wsp.lwavgrid, wsp.rwavgrid, wsp.allwavs, wsp.allints)
    return nothing
end

function line_profile!(mid::T, lambdas::AA{T,1}, prof::AA{T,1},
