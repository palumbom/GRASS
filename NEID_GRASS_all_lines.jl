...
function neid_all_lines(neid_time, granulation_status)
    ...
    for i in eachindex(lp.λrest) 
        ...
        lambdas_cpu, outspec_cpu = GRASS.synthesize_spectra_eclipse(spec, disk, obs_long, obs_lat, alt, lines ./ 10.0, time_stamps, "Optical", neid_ext_coeff, verbose=true, use_gpu=false)
...
# @save "neid_all_lines_rv_regular_ext.jld2"
# jldopen("neid_all_lines_rv_regular_ext.jld2", "a+") do file
#     file["name"] = λrest 
#     file["rv"] = rv 
...
@save "neid_all_lines_rv_off_ext.jld2"
jldopen("neid_all_lines_rv_off_ext.jld2", "a+") do file
    file["name"] = λrest 
    file["rv"] = rv 
    file["rv_error"] = rv_error 
end
