...
# @save "neid_all_lines_rv_regular_KSSD_ext.jld2"
# jldopen("neid_all_lines_rv_regular_KSSD_ext.jld2", "a+") do file
...
@save "neid_all_lines_rv_off_KSSD_ext.jld2"
jldopen("neid_all_lines_rv_off_KSSD_ext.jld2", "a+") do file
    file["name"] = deepcopy(λrest) 
    file["rv"] = deepcopy(rv) 
    file["rv_error"] = deepcopy(rv_error)
end
