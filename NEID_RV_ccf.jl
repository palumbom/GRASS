...
function first_timestamp_lines(line_names, airwav, vacwav, orders, neid_timestamps, timestamps, path, obs_long, obs_lat, alt)
...
function GRASS_comparison(line_names, airwav, vacwav, orders, neid_timestamps, timestamps, path, obs_long, obs_lat, alt)
    #convert from utc to et as needed by SPICE
    time_stamps = utc2et.(neid_timestamps)
...
# #april
# RV_all_lines, RV_error_all_lines = line_rvs_ccf(line_names, airwav, vacwav, orders, neid_timestamps_april, timestamps_april, path_april, obs_long, obs_lat, alt)
# @save "neid_RVlinebyline_april_FeI_5383_fullR.jld2"
# jldopen("neid_RVlinebyline_april_FeI_5383_fullR.jld2", "a+") do file
...
# #for first timestamp (out of transit) of October eclipse, line comparsion between IAG, GRASS, and NEID
# first_timestamp_lines(line_names, airwav, vacwav, orders, neid_timestamps_october, timestamps_october, path_october, obs_long, obs_lat, alt)

# #for first timestamp (out of transit) of October eclipse, line and bisector comparsion between GRASS and NEID
# GRASS_comparison(line_names, airwav, vacwav, orders, neid_timestamps_october, timestamps_october, path_october, obs_long, obs_lat, alt)